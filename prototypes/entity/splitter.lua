...
mk4.icon = "__FactorioExtended-Plus-Assets2__/transport/icons/" .. mk4.name .. ".png"
mk4.icon_size = 64
mk4.icon_mipmaps = 4
...
for _, direction in pairs({"north", "east", "south", "west"}) do
    mk4.structure[direction].filename = "__FactorioExtended-Plus-Assets2__/transport/entity/rapid-transport-mk1/hr-rapid-splitter-" .. direction .. "-mk1.png"
end
...
mk5.icon = "__FactorioExtended-Plus-Assets2__/transport/icons/" .. mk5.name .. ".png"
mk5.icon_size = 64
mk5.icon_mipmaps = 4
...
for _, direction in pairs({"north", "east", "south", "west"}) do
    mk5.structure[direction].filename = "__FactorioExtended-Plus-Assets2__/transport/entity/rapid-transport-mk2/hr-rapid-splitter-" .. direction .. "-mk2.png"
end
